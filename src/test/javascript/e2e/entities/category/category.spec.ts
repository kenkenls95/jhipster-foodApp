...
describe('Category e2e test', () => {
  ...
  it('should load Categories', async () => {
    ...
    expect(await categoryComponentsPage.getTitle()).to.eq('foodApp.category.home.title');
  ...
  it('should load create Category page', async () => {
    ...
    expect(await categoryUpdatePage.getPageTitle()).to.eq('foodApp.category.home.createOrEditLabel');
  ...
  it('should create and save Categories', async () => {
    ...
    await promise.all([categoryUpdatePage.setCategoryidInput('5'), categoryUpdatePage.setCategorynameInput('categoryname')]);

    expect(await categoryUpdatePage.getCategoryidInput()).to.eq('5', 'Expected categoryid value to be equals to 5');
  ...
  it('should delete last Category', async () => {
    ...
    expect(await categoryDeleteDialog.getDialogTitle()).to.eq('foodApp.category.delete.question');
